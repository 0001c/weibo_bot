...
<div align="center">
<img width="1200" height="475" alt="GHBanner" src="https://github.com/0001c/weibo_bot/blob/main/%E5%B1%8F%E5%B9%95%E6%88%AA%E5%9B%BE_2-3-2026_18818_localhost.jpeg?raw=true" />
</div>
...
- **微博监控** 📱：自动监控指定用户的新微博
- **AI回复** 🤖：使用豆包 API生成智能回复内容
- **Web配置** 🌐：提供网页界面进行配置管理
- **Docker部署** 🐳：支持Docker容器化部署
- **自动化运行** ⚙️：可在后台持续运行，定期检查新内容
- **用户级别控制** 🎯：支持启用/禁用特定用户的爬虫
- **日志管理** 📝：支持日志查看、过滤、搜索和清空
- **现代化UI** 🎨：采用渐变色彩，实现响应式设计
...
- **v1.2.0** 🐳：支持Docker部署
- **v1.3.0** 🤖：优化AI回复生成
- **v1.4.0** 🎯：添加用户ID启用/禁用功能，支持用户级别的爬虫控制
- **v1.5.0** 📝：实现日志管理功能，支持日志查看、过滤、搜索和清空
- **v1.6.0** 🎨：UI全面美化优化，渐变色彩，实现响应式设计
